...
func _on_shoot_timer() -> void:
	...
	get_parent().add_child(enemy_projectile_left)
	...
	get_parent().add_child(enemy_projectile_top)
	...
	get_parent().add_child(enemy_projectile_right)
	...
	get_parent().add_child(enemy_projectile_down)
